...
The 'documentation.md' file provides all technical details of the module. The 'pyconformap.py' file contains the code for the module.  The 'illlustrated_example.ipynb' jupyter notebook file shows examples to illustrate implementation of the code. 
